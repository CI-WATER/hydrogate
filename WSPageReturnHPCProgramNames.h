...
#ifndef WSPAGERETURNHPCPROGRAMNAMES_H
#define	WSPAGERETURNHPCPROGRAMNAMES_H

#include "WSPage.h"

class WSPageReturnHPCProgramNames : public WSPage {
public:
    WSPageReturnHPCProgramNames();
    virtual void process(WSParameter& parameter);
private:

};

#endif	/* WSPAGERETURNHPCPROGRAMNAMES_H */
