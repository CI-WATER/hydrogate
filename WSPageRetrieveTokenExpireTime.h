...
#ifndef WSPAGERETRIEVETOKENEXPIRETIME_H
#define	WSPAGERETRIEVETOKENEXPIRETIME_H

#include "WSPage.h"

class WSPageRetrieveTokenExpireTime : public WSPage {
public:
    WSPageRetrieveTokenExpireTime();
    virtual void process(WSParameter& parameter);
private:

};

#endif	/* WSPAGERETRIEVETOKENEXPIRETIME_H */
