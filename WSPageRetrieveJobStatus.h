...
#ifndef WSPAGERETRIEVEJOBSTATUS_H
#define	WSPAGERETRIEVEJOBSTATUS_H

#include "WSPage.h"

class WSPageRetrieveJobStatus : public WSPage {
public:
    WSPageRetrieveJobStatus();
    virtual void process(WSParameter& parameter);
private:

};

#endif	/* WSPAGERETRIEVEJOBSTATUS_H */
