...
#ifndef WSPAGERETRIEVEPACKAGESTATUS_H
#define	WSPAGERETRIEVEPACKAGESTATUS_H

#include "WSPage.h"

class WSPageRetrievePackageStatus : public WSPage {
public:
    WSPageRetrievePackageStatus();
    virtual void process(WSParameter& parameter);
private:

};

#endif	/* WSPAGERETRIEVEPACKAGESTATUS_H */
