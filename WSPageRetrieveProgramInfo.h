...
#ifndef WSPAGERETRIEVEPROGRAMINFO_H
#define	WSPAGERETRIEVEPROGRAMINFO_H

#include "WSPage.h"

class WSPageRetrieveProgramInfo  : public WSPage {
public:
    WSPageRetrieveProgramInfo();
    virtual void process(WSParameter& parameter);
private:
};

#endif	/* WSPAGERETRIEVEPROGRAMINFO_H */
